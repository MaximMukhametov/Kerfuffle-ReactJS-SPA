...
test('after deleting length of messages should be decremented if id is correct', () => {
...
test('after deleting length of messages shouldn`t be decremented if id is not correct', () => {
    let messagesCount = state.posts.length
